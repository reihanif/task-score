@if ($attributes->has('label'))
    <div class="mb-2 block cursor-default text-sm font-medium text-gray-900 dark:text-white">
...
<div class="mb-4"
    ...
    <div class="h-fit w-full rounded-lg border border-gray-200 bg-gray-50 dark:border-gray-600 dark:bg-gray-700">
        ...
        <div class="relative border-b bg-white p-2.5 dark:border-gray-600 dark:bg-gray-700">
        ...
        <p class="px-1.5 py-0.5 text-right text-xs font-normal text-gray-500 dark:text-gray-400">
