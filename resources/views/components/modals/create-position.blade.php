                ...
                <div class="mb-4 grid gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        <div class="flex items-center">
                            <input id="secretary-checkbox" type="checkbox" name="is_secretary" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="secretary-checkbox" class="ms-2 text-sm text-gray-900 dark:text-gray-300">This is a secretary position</label>
                        </div>
                    </div>
                    <div>
