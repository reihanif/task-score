<div {{ $attributes }}>
    ...
    <div class="z-50 my-4 hidden max-w-sm list-none divide-y divide-gray-100 overflow-hidden rounded-xl bg-white text-base shadow-lg dark:divide-gray-600 dark:bg-gray-700"
        ...
        <div
             class="block bg-gray-50 px-4 py-2 text-center text-base font-medium text-gray-700 dark:bg-gray-700 dark:text-gray-300">
            Notifications
        </div>
                    ...
                    <div class="relative flex-shrink-0">
                        ...
                        @switch($notification->type)
                            ...
                            @case('assignment-submitted')
                                <div
                                     class="absolute -mt-5 ml-6 flex h-5 w-5 items-center justify-center rounded-full border border-white bg-yellow-500 dark:border-gray-700">
                            ...
                            @case('assignment-approved')
                                <div
                                     class="absolute -mt-5 ml-6 flex h-5 w-5 items-center justify-center rounded-full border border-white bg-green-700 dark:border-gray-700">
                            ...
                            @case('assignment-rejected')
                                <div
                                     class="absolute -mt-5 ml-6 flex h-5 w-5 items-center justify-center rounded-full border border-white bg-red-700 dark:border-gray-700">
