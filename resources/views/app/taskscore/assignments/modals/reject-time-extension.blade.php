...
<div class="fixed left-0 right-0 top-0 z-50 hidden h-[calc(100%-1rem)] max-h-full w-full items-center justify-center overflow-y-auto overflow-x-hidden md:inset-0"
    id="reject-time-extension-modal-{{ $time_extension->id }}"
    tabindex="-1">
    <form x-on:submit="loading = ! loading"
        action="{{ route('taskscore.assignment.time-extension-reject', $time_extension->id) }}"
        method="post">
        @csrf
        @method('put')
        <div class="relative max-h-full w-full max-w-md p-4">
            <div class="relative rounded-lg bg-white shadow dark:bg-gray-700">
                <button
                    ...
                    data-modal-hide="reject-time-extension-modal-{{ $time_extension->id }}"
                    type="button">
                ...
                <div class="p-4 text-center md:p-5">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to
                        reject this time extension request?</h3>
                    ...
                    <button
                        ...
                        data-modal-hide="approve-submission-modal-{{ $submission->id }}"
