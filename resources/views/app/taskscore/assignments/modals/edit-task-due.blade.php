                            ...
                            <div>
                                ...
                                <div>
                                    <div class="relative">
                                        ...
                                        <input x-init="initializeDatepickers()" datepicker x-bind:disabled="selectedOption !== 'exact-time'" autocomplete="off" id="input-recurrence-end-date" type="text" name="date" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date">
                                    </div>
                                </div>
                            </div>
                            <div>
