                    ...
                    <ul class="w-full items-center rounded-lg border border-gray-200 bg-white text-sm font-medium text-gray-900 dark:border-gray-600 dark:bg-gray-700 dark:text-white sm:flex">
                        <li class="w-full border-b border-gray-200 dark:border-gray-600 sm:border-b-0 sm:border-r">
                            <div class="interval flex items-center ps-3">
                                <input
                                    ...
                                    id="select-interval{{ $time_extension->id }}"
                                    type="radio"
                                    value="interval-time"
                                    name="due{{ $time_extension->id }}"
                                    x-model="selectedOption"
                                    required>
                                <label class="ms-2 w-full py-3 text-sm font-medium text-gray-900 dark:text-gray-300"
                                    for="select-interval{{ $time_extension->id }}">
                                    Select by interval
                                </label>
                            </div>
                        <li class="w-full dark:border-gray-600">
                            <div class="exact-time flex items-center ps-3">
                                <input
                                    class="h-4 w-4 border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-500 dark:bg-gray-600 dark:ring-offset-gray-700 dark:focus:ring-blue-600 dark:focus:ring-offset-gray-700"
                                    id="select-exact-time{{ $time_extension->id }}"
                                    type="radio"
                                    value="exact-time"
                                    name="due{{ $time_extension->id }}"
                                    x-model="selectedOption"
                                    required>
                                <label class="ms-2 w-full py-3 text-sm font-medium text-gray-900 dark:text-gray-300"
                                    for="select-exact-time{{ $time_extension->id }}">
                                    Select exact time
                                </label>
                            </div>
                        </li>
