...
<x-modal id="upload-attachment-modal"
            data-title="Upload attachment">
    <!-- Modal body -->
    <form class="p-4 md:p-5"
            x-on:submit="loading = ! loading"
            action="{{ route('taskscore.assignment.store-attachment', $assignment->id) }}"
            method="post"
            ...
            <div class="space-y-4">
                <div class="col-span-2">
                    <label class="mb-2 inline-flex gap-1 text-sm font-medium text-gray-900 dark:text-white"
                           for="assignment-file">Attachment
