...
@section('content')
    <div class="grid grid-cols-12 gap-3">
        ...
        <div class="col-span-full md:order-2 md:col-span-3">
            <div class="grid">
                <div
                    class="text-sm border-1 relative space-y-4 rounded-lg border border-gray-200 p-4 dark:border-gray-700 dark:bg-gray-800">
                    ...
                    <div class="text-gray-500 dark:text-gray-400">
                        ...
                        <p>
                            ...
                            <span>{{ '(' . $assignment->due->diffForHumans() . ')' }}</span>
                        </p>
                    </div>
                    <div class="text-gray-500 dark:text-gray-400">
                            ...
                            <h6 class="mr-3 text-sm font-bold dark:text-white">Attachments</h6>
                                <ul class="divide-y divide-gray-100 rounded-md border border-gray-200 dark:divide-gray-700 dark:border-gray-700"
                                    ...
                                    @foreach ($assignment->attachments as $attachment)
                                        <li title="{{ $attachment->name . '.' . $attachment->extension }}" class="flex items-center justify-between py-4 pl-4 pr-5 text-sm leading-6">
