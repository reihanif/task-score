...
@section('content')
    <div
        ...
        <div class="flex-row items-center justify-between space-y-3 sm:flex sm:space-x-4 sm:space-y-0">
            <div>
                <h5 class="mr-3 font-semibold dark:text-white">Notifications</h5>
                <p class="text-gray-500 dark:text-gray-400">Showing all your notifications history</p>
            </div>
        </div>
            ...
            <div id="search">
                <div class="relative">
                    ...
                    <input
                        ...
                        data-filter-target="notifications-table"
                ...
                <tbody>
                    @foreach ($notifications as $key => $notification)
                        <tr class="cursor-pointer border-b bg-white hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-600"
                            data-href="{{ $notification->data['action'] }}">
