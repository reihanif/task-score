            ...
            <form class="mt-6 border-t border-gray-100 dark:border-gray-700"
                ...
                <dl class="divide-y divide-gray-100 dark:divide-gray-700">
                    ...
                    <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                        ...
                        <dd class="mt-1 text-sm leading-6 text-gray-700 dark:text-gray-400 sm:mt-0">
                            <label class="inline-flex cursor-pointer items-center">
                                @if (!$user->hasPermission('manage-department'))
                                    <input class="peer sr-only"
                    ...
                    <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                        ...
                        <dd class="mt-1 text-sm leading-6 text-gray-700 dark:text-gray-400 sm:col-span-2 sm:mt-0">
                            <label class="inline-flex cursor-pointer items-center">
                                @if (!$user->hasPermission('manage-position'))
                                    <input class="peer sr-only"
                    ...
                    <div class="px-4 pb-0 pt-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                        ...
                        <dd class="mt-1 text-sm leading-6 text-gray-700 dark:text-gray-400 sm:col-span-2 sm:mt-0">
                            <button class="mb-2 me-2 rounded-lg bg-blue-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
