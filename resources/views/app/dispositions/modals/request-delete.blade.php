<x-modal id="request-delete-dispo-modal"
         data-title="Request Delete Disposition">
    <!-- Modal body -->
    <form class="p-4 md:p-5"
        x-on:submit="loading = ! loading"
        x-bind:action="'/dispositions/request-delete/' + reqDeleteId"
        method="post">
        @csrf
        <div class="mb-5">
            <div class="space-y-4">
                <div class="col-span-2">
                    <x-forms.text-editor name="reason"
                                         value="{{ old('reason') }}"
                                         label="Reason for deletion"
                                         placeholder="Enter reason for disposition deletion"
                                         required>
                    </x-forms.text-editor>
                </div>
            </div>
